...
def plot_la_vs_height(df):
    ...
    odir = "plots"
    fig.savefig(os.path.join(odir, "la_vs_height_Eucs_vs_EBF.pdf"),
                bbox_inches='tight', pad_inches=0.1)

    #plt.show()


def plot_la_vs_height_species(df):
    ...
    odir = "plots"
    ofname = os.path.join(odir, "la_vs_height_Eucs_vs_EBF_species.pdf")
