...
def plot_stem_mass_vs_height_species(df):
    ...
    df_eucs = df_eucs[['species','h.t', 'm.st']]
    ...
    odir = "plots"
    ofname = os.path.join(odir, "stem_mass_vs_height_Eucs_vs_EBF_species.pdf")
...
if __name__ == "__main__":
    ...
    plot_stem_mass_vs_height_species(df)
